...
namespace Sinba.BusinessModel.Entity
{
    ...
    public class CessionPlantationViewModels
    {


        public CessionPlantationViewModels()
        {
            ListContat = new HashSet<Contact>();
            DonneeGeographiques = new HashSet<DonneeGeographique>();
            DonneeGeographiquesViewModel = new HashSet<DonneeGeographiquePlantationViewModels>();
            SuperficieViewModel = new HashSet<SuperficieViewModels>();
       ...
       [StringLength(10)]
        ...
        [Display(Name = ResourceNames.Entity.PlantationID, ResourceType = typeof(EntityColumnResource))]
        [StringLength(7)]
        public string PrecedentPlantationID { get; set; }
        ...
        [Display(Name = ResourceNames.Entity.DateGeolocalisation, ResourceType = typeof(EntityColumnResource))]
        public DateTime AncienneDateGeolocalisation { get; set; }
        ...
        //[Display(Name = ResourceNames.Entity.Superficie, ResourceType = typeof(EntityColumnResource))]
        public double? SurficieInitiale { get; set; }

        //[Display(Name = ResourceNames.Entity.Superficie, ResourceType = typeof(EntityColumnResource))]
        public double? SuperficieFinale { get; set; }
        ...
        public virtual ICollection<SuperficieViewModels> SuperficieViewModel { get; set; }
        public virtual ICollection<DonneeGeographiquePlantationViewModels> DonneeGeographiquesViewModel { get; set; }
        ...
        public virtual ICollection<CessionPlantationViewModels> ListSuperficie { get; set; }
    ...
    public class DonneeGeographiquePlantationViewModels
    {

        public DonneeGeographiquePlantationViewModels()
        {
            DonneeGeographiquesViewModel = new HashSet<DonneeGeographiquePlantationViewModels>();
        }
    ...
    public class SuperficieViewModels
    {

        public SuperficieViewModels()
        {
            SuperficieViewModel = new HashSet<SuperficieViewModels>();
        }
