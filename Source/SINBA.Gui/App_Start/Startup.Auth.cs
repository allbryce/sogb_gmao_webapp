...
namespace Sinba_Gui
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(SinbaContext.Create);
            ...
            {
                ExpireTimeSpan = TimeSpan.FromMinutes(AppSettings.DoubleValue(SinbaConstants.ConfigKeys.SessionTimeout)),
                ...
                Provider = new CookieAuthenticationProvider
                {
                    ...
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, SinbaUser>(
